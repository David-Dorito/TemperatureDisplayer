...
The project shows low-level peripheral integration and driver development in a single embedded project.
...
The primary goal was to implement reusable drivers which do not rely on vendor HAL libraries.
